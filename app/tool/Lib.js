...
import {CircularProgress,AppBar,RaisedButton,Dialog,FlatButton,IconButton} from "material-ui";
    ...
    StartWidght: React.createClass({
        render: function () {
            return (<div className='am-text-center starting-content'>
                    <ReactCSSTransitionGroup transitionName='index' transitionEnterTimeout={0}
        ...
        render: function () {
            ...
            return (
                ...
                <RaisedButton
                    ...
                    label={isLoading?this.props.loadingText:this.props.children}
                    disabled={isLoading}
